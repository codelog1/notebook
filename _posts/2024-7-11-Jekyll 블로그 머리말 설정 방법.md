...
[Jekyll 고유주소](https://jekyllrb-ko.github.io/docs/permalinks/){:target="_blank"}

[Jekyll Theme 적용 및 첫번째 포스트 작성하기](https://hoontae24.github.io/2){:target="_blank"}

[jekyll 더 알아보기](https://ehfgk78.github.io/2017/12/27/jekyll-detail/){:target="_blank"}
...
[지킬(Jekyll)블로그 올린 포스트 비공개로 하기](https://twpower.github.io/86-make-jekyll-blog-post-private){:target="_blank"}
...
[첫번째 포스트 게시하기](https://seungwubaek.github.io/blog/first_post/){:target="_blank"}
...
이렇게 설정하면 모든 포스트에 기본적으로 `post` 레이아웃과 "Your Name"이라는 작성자가 적용됩니다.
...
- **주의사항**
    ...
    [Jekyll 페이지 나누기](https://jekyllrb-ko.github.io/docs/pagination/){:target="_blank"}
    
    [JeKyll 커스터마이징 - (6) 페이지 매기기](https://namhoon.kim/2017/03/27/jekyll/023/index.html){:target="_blank"}
...
이렇게 하면 포스트의 날짜를 포함하여 고유주소를 설정할 수 있습니다.

[JeKyll 컨텐츠 - (7) 컬렉션(Collections) - 사용법과 변수](https://namhoon.kim/2017/03/23/jekyll/014/index.html){:target="_blank"}
...
[Jekyll Layouts](https://jekyllrb.com/docs/layouts/){:target="_blank"}
...
이를 통해 해당 경로와 유형에 해당하는 모든 콘텐츠는 자동으로 지정된 레이아웃을 사용하게 됩니다.

[Jekyll 머리말 기본값](https://jekyllrb-ko.github.io/docs/configuration/front-matter-defaults/){:target="_blank"}

[Use Jekyll Front Matter Defaults to set your layouts](https://www.johanbleuzen.fr/blog/use-jekyll-front-matter-defaults-set-layouts){:target="_blank"}
...
[Jekyll Layouts](https://jekyllrb.com/docs/step-by-step/04-layouts/){:target="_blank"}

[Stack Overflow - Modifying an existing Jekyll theme to have static homepage](https://stackoverflow.com/questions/61872008/modifying-an-existing-jekyll-theme-to-have-static-homepage){:target="_blank"}
...
[Overriding CSS file in a layout](https://talk.jekyllrb.com/t/overriding-css-file-in-a-layout/294){:target="_blank"}
